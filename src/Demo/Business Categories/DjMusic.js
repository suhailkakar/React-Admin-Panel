...
class BasicButton extends React.Component {
    ...
    componentDidMount() {
        ...
        axios.get('https://seheri.saikiranreddy.com/users/djmusic/all', {
            headers: headers
                            ...
                            <tbody>
                                {this.state.users.map((data, id) =>
                                    <tr>
                                        ...
                                        <td>
                                            <a href={'vendor/djmusic/details?user_id=' + data._id}><button style={{ fontSize: "15px", borderRadius: "16px" }} className="label theme-bg2 text-white f-12" >View Details</button> </a>
